 ...
 * @author Guilherme
 */
public class BuscarSubprodutos extends javax.swing.JFrame {
    ...
    public BuscarSubprodutos() throws BancoException {
        initComponents();
        Tabela();
            ...
            public void windowClosing(WindowEvent evt) {
                try {
                    try {
                        ...
                        Logger.getLogger(BuscarSubprodutos.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    public void Fechando() throws BancoException, SQLException {
        this.dispose();
        SubProdutosInterface Inserindo = new SubProdutosInterface(0);
        Inserindo.setVisible(true);
    }
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ESCAPE) {
            BuscarSubprodutos.this.dispose();
        }
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        if (linha == -1) {
            ...
            try {
                SP = new SubProdutosInterface(Integer.parseInt(Codigo));
                SP.setVisible(true);
                this.dispose();
            } catch (SQLException ex) {
                Logger.getLogger(BuscarSubprodutos.class.getName()).log(Level.SEVERE, null, ex);
