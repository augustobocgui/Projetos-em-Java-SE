 ...
 * @author Guilherme
 */
public class PrecosProdutos extends javax.swing.JFrame {

  
    /**
     * Creates new form JFPesquisarMateriais
     */
    public PrecosProdutos(String telaPai) {
        initComponents();
        setLocation(210, 120);
    ...
    private void initComponents() {
        ...
        jButton1.setToolTipText("Ir para interface Estoque.");
    ...
    public DefaultTableModel getDadosTabelaPesquisa() {
        try {
            ...
            for (int us = 0; us < lista.size(); us++) {
                ...
                dados[us][2] = lista.get(us).getPrecoCompra();
                dados[us][3] = lista.get(us).getPrecoVenda();
            }
            lista = null; 
            dao.desconectar();
            String[] nomeColunas = {"Código", "Nome", "Preço Custo", "Preço Venda"};
