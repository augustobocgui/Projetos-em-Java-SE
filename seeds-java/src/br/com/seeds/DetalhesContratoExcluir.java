 ...
 * @author Guilherme
 */
public class DetalhesContratoExcluir extends javax.swing.JFrame {
     ...
     */
    public DetalhesContratoExcluir() throws BancoException, SQLException, ParseException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jBConcluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/imagens/edit-delete.png"))); // NOI18N
        jBConcluir.setText("Excluir contrato");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(81, 81, 81)
                .addComponent(jLErroAOFiltraContrato, javax.swing.GroupLayout.DEFAULT_SIZE, 567, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jBConcluir, jButton1});
...
private void jBConcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBConcluirActionPerformed
    ...
    private void jScrollPane1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jScrollPane1MouseEntered
        if (registro < 1) {
            ...
            try {
                ...
                Logger.getLogger(DetalhesContratoExcluir.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public DefaultTableModel getDadosTabelaClientePesquisa() {
        ...
        do {
            try {
                FileReader arq = new FileReader("../seeds-java/Arquivo.txt");
        ...
        try {
            ...
            dao.desconectar();
            daos.desconectar();
            String[] nomeColunas = {"CONTRATO", "Cliente", "Local", "Nome"};
