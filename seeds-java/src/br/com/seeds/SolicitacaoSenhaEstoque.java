 ...
 * @author Guilherme
 */
public class SolicitacaoSenhaEstoque extends javax.swing.JDialog {

    String s, f;

    /**
     * Creates new form SolicitacaoSenhaEstoque
     */
    public SolicitacaoSenhaEstoque(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton3.setBounds(421, 280, 50, 40);
    ...
    private void txtUsuarioKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtUsuarioKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ESCAPE) {
            SolicitacaoSenhaEstoque.this.dispose();
        }
            ...
            if (txtUsuario.getText().equals("")) {
                ...
                try {
                    ...
                    if (Verificando.getSenha().equals(senhaMD5) && Verificando.getTipo().equals("Administrador")) {
                        ...
                        SolicitacaoSenhaEstoque.this.dispose();
                        new FramePaiEstoques(null, rootPaneCheckingEnabled).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SolicitacaoSenhaEstoque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SolicitacaoSenhaEstoque dialog = new SolicitacaoSenhaEstoque(new javax.swing.JFrame(), true);
