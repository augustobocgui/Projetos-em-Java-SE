...
public class BuscarProfessores extends javax.swing.JFrame {
     ...
     */
    public BuscarProfessores(String telaPai) {
        initComponents();
...
private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
    if (evt.getKeyCode() == KeyEvent.VK_ESCAPE) {
        BuscarProfessores.this.dispose();
    }
    ...
    public DefaultTableModel getDadosTabelaClientePesquisa() {
        try {
            ...
            List<Professor> lista = dao.pesquisaProfessor(parametroPesquisa, campo);
