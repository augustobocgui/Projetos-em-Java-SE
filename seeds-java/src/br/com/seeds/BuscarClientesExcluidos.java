 ...
 * @author Guilherme
 */
public class BuscarClientesExcluidos extends javax.swing.JFrame {
     ...
     */
    public BuscarClientesExcluidos(String telaPai) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Importar Alunos Excluídos");
        setResizable(false);
...
private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
    if (evt.getKeyCode() == KeyEvent.VK_ESCAPE) {
        BuscarClientesExcluidos.this.dispose();
    }
...
private void jTextField1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyTyped
    ...
    public DefaultTableModel getDadosTabelaClientePesquisa() {
        try {
            ...
            List<Cliente> lista = dao.pesquisaClienteExcluido(parametroPesquisa, campo);
