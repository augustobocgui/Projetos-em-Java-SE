 ...
 * @author Guilherme
 */
public class BuscarSubprodutosCaixaVenda extends javax.swing.JFrame {
    ...
    public BuscarSubprodutosCaixaVenda() throws BancoException {
        initComponents();
        Tabela();
    ...
    public void Fechando() throws BancoException, SQLException, ParseException {
        this.dispose();
        CaixaEntradaVenda Caixa = new CaixaEntradaVenda(0);
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ESCAPE) {
            BuscarSubprodutosCaixaVenda.this.dispose();
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            CaixaEntradaVenda SP;
            try {
                try {
                    SP = new CaixaEntradaVenda(Integer.parseInt(Codigo));
                    SP.setVisible(true);
                } catch (ParseException ex) {
                    Logger.getLogger(BuscarSubprodutosCaixaVenda.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //Cancelar
        CaixaEntradaVenda Caixa;
        try {
            try {
                Caixa = new CaixaEntradaVenda(0);
                Caixa.setVisible(true);
            } catch (ParseException ex) {
                Logger.getLogger(BuscarSubprodutosCaixaVenda.class.getName()).log(Level.SEVERE, null, ex);
            }
