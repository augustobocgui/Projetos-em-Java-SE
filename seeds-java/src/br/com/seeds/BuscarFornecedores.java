 ...
 * @author Guilherme
 */
public class BuscarFornecedores extends javax.swing.JFrame {

    /**
     * Creates new form JFPesquisaFornecedores
     */
    public BuscarFornecedores(String telaPai) {
        initComponents();
...
private void masterTableMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_masterTableMouseReleased
    ...
    codigoFornecedor = masterTable.getValueAt(linha, 0).hashCode();
    nomeFornecedor = "" + masterTable.getValueAt(linha, 1);
    btnOk.requestFocus();
...
private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
    ...
    if (linha == -1) {
        ...
        nomeFornecedor = masterTable.getValueAt(linha, 1).toString();
        this.dispose();
    }
...
private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
    if (evt.getKeyCode() == KeyEvent.VK_ESCAPE) {
        BuscarFornecedores.this.dispose();
    }
    ...
    public DefaultTableModel getDadosTabelaClientePesquisa() {
        try {
            ...
            List<Fornecedor> lista = dao.pesquisaFornecedor(parametroPesquisa, campo);
            ...
            for (int us = 0; us < lista.size(); us++) {
                ...
                dados[us][2] = lista.get(us).getCnpj();
                //dados[us][4]=lista.get(us).getCpf();
            }
            lista = null;
            dao.desconectar();
            String[] nomeColunas = {"Código", "Nome", "CNPJ"};
