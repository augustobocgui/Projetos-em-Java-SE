...
public class SplahContratoTodos extends JWindow {
    ...
    public SplahContratoTodos(int lista) {
        fechar = lista;
            ...
            public void run() {
                ...
                while (progresso < 100) {
                    ...
                    if (jbutton.isSelected() == true) {
                        SplahContratoTodos.this.dispose();
                    }
                    i++;
                    if (reduzir <= i) {
                        progresso++;
                    ...
                    try {
                        ...
                        Logger.getLogger(SplahContratoTodos.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
                new BuscarClientesContratosExcluir().setVisible(true);
                SplahContratoTodos.this.dispose();
            }
        }.start();
        this.pack();
